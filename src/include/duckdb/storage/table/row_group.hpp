...
public:
	...
	void Scan(TransactionData transaction, CollectionScanState &state, DataChunk &result, optional_ptr<ClientContext> context = nullptr);
	void ScanCommitted(CollectionScanState &state, DataChunk &result, TableScanType type, optional_ptr<ClientContext> context = nullptr);
...
private:
	...
	void TemplatedScan(TransactionData transaction, CollectionScanState &state, DataChunk &result, optional_ptr<ClientContext> context);
